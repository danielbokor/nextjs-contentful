...
export default function RelatedPosts() {
  const items = [
    {
      ...
      img: CustomerImg02,
      bg: CustomerBg02,
      link: "/customers/how-airbnb-leverages-stellar-x-to-onboard-new-hosts",
    },
    {
      name: "Customer name",
      img: CustomerImg03,
  ...
  return (
    <aside>
      <h2 className="inline-flex font-bold text-lg bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-8">
        Related stories
      </h2>
